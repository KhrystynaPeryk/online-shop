...
const DrawerMiniCart = ({isDrawerOpen, setIsDrawerOpen, products}: DrawerMiniCart) => {
    ...
    return (
        <Drawer anchor="right" open={isDrawerOpen} onClose={setIsDrawerOpen}>
            <Typography sx={{fontSize: 'large', fontWeight: 'bold', fontFamily: 'inherit', textAlign: 'center', margin: '10px'}}>My Bag, {products.reduce((acc, currVal) => acc + currVal.quantity, 0)} items</Typography>
